...
extern int allowRefill;
extern int allowDropping;
extern int allowSwapping;
extern int configTplCnt;
extern int maintTplCnt;

extern double alpha;
extern int sdf;
extern int printDbg;
extern int gucLength;
