...
PG_KEYWORD("confidence", CONFIDENCE, RESERVED_KEYWORD)
...
//PG_KEYWORD("delta", DELTA RESERVED_KEYWORD)
...
PG_KEYWORD("maintenance", MAINTENANCE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("ondemand", ONDEMAND, UNRESERVED_KEYWORD)
...
PG_KEYWORD("simplereestimate", SIMPLEREESTIMATE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("timeseries", TIMESERIES, RESERVED_KEYWORD)
