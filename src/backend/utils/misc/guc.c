...
{
	{
		{"allowRefill", PGC_USERSET, CUSTOM_OPTIONS,
	...
	{
		{"allowDropping", PGC_USERSET, CUSTOM_OPTIONS,
				gettext_noop("Da very special secrete DB-flag."),
		},
		&allowDropping,
		0, 0, 1, NULL, NULL
	...
	{
		{"allowSwapping", PGC_USERSET, CUSTOM_OPTIONS,
				gettext_noop("Da very special secrete DB-flag."),
		},
		&allowSwapping,
		0, 0, 1, NULL, NULL
	...
	{
		{"configTupleCount", PGC_USERSET, CUSTOM_OPTIONS,
				gettext_noop("Da very special secrete DB-flag."),
		},
		&configTplCnt,
		5, 0, 1000, NULL, NULL
	...
	{
		{"maintTupleCount", PGC_USERSET, CUSTOM_OPTIONS,
				gettext_noop("Da very special secrete DB-flag."),
		},
		&maintTplCnt,
		5, 0, 1000, NULL, NULL
	...
	{
		{"printDebug", PGC_USERSET, CUSTOM_OPTIONS,
				gettext_noop("Da very special secrete DB-flag."),
		},
		&printDbg,
		0, 0, 1, NULL, NULL
	...
	{
		{"gucLength", PGC_USERSET, CUSTOM_OPTIONS,
				gettext_noop("Da very special secrete DB-flag."),
		},
		&gucLength,
		5, 0, 500, NULL, NULL
	...
	{
		{"sdf", PGC_USERSET, CUSTOM_OPTIONS,
			gettext_noop("Da very special secrete DB-flag."),
		},
		&sdf,
	...
	{
		{"log_StatementTime", PGC_SUSET, LOGGING_WHEN,
				gettext_noop("Sets the id used in the pg_commandTimings table"),
				gettext_noop("-1: no times are logged")
		},
		&log_StatementTime,
		-1, -1, INT_MAX, NULL, NULL
	},
	...
	{
		{"ar_step", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Sets the number of shared memory buffers used by the server."),
			NULL
	...
	{
		{"ar_start", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Sets the number of shared memory buffers used by the server."),
			NULL
