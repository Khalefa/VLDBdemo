...
%type <node>	stmt schema_stmt
		...
		CreateDisAggSchemeStmt FillModelGraphStmt ReestimateModelGraphModelsStmt MaintenanceModelGraphStmt
		
%type <node>	AlgorithmClause algorithm_parameter
%type <list>	algorithm_parameter_list algorithm_parameters opt_algorithm_parameter_list
...
%type <node>	forecast_clause opt_algorithm_clause opt_forecast_clause opt_on_clause opt_confidence_clause
				opt_a_expr
...
%type <ival>	fill_method_clause opt_storage_clause opt_mergeclause opt_maintenance_clause granularity_clause opt_number_clause
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	COMMITTED COMPLETE CONCURRENTLY CONFIDENCE CONFIGURATION CONNECTION CONSTRAINT CONSTRAINTS
	...
	MAINTENANCE MAPPING MATCH MAXVALUE METHOD MINUTE_P MINVALUE MODE MODEL MODELGRAPH MODELINDEX MONTH_P MOVE MULT

	NAME_P NAMES NATIONAL NATURAL NCHAR NEW NEXT NO NOCREATEDB
	NOCREATEROLE NOCREATEUSER NOINHERIT NOLOGIN_P NONE NOSUPERUSER
	NOT NOTHING NOTIFY NOTNULL NOWAIT NULL_P NULLIF NULLS_P NUMBER NUMERIC

	OBJECT_P OF OFF OFFSET OIDS OLD ON ONDEMAND ONLY OPERATOR OPTION OPTIONS OR
	...
	SHOW SIMILAR SIMPLE SIMPLEREESTIMATE SMALLINT SOME STABLE STANDALONE_P START STATEMENT
	STATISTICS STRATEGY STDIN STDOUT STORAGE STORE STRICT_P STRIP_P SUBSTRING SUPERUSER_P
	SYMMETRIC SYSID SYSTEM_P

	TABLE TABLESPACE TEMP TEMPLATE TEMPORARY TEXT_P THEN TIME TIMESERIES TIMESTAMP
	...
	WEEK_P WHEN WHERE WHITESPACE_P WINDOW WITH WITHOUT WORK WRAPPER WRITE
...
CreateStmt:	CREATE OptTemp TABLE qualified_name '(' OptTableElementList ')'
		...
		| CREATE OptTemp TABLE qualified_name OF qualified_name
			...
			CREATE OptTemp TIMESERIES qualified_name '(' OptTableElementList ')'
			OptInherit OptWith OnCommitOption OptTableSpace
				{
					CreateStmt *n = makeNode(CreateStmt);
					$4->istemp = $2;
					...
					n->tablespacename = $11;
					n->isarray = 1;
					//elog(WARNING, "isarray %d", n->isarray);
					$$ = (Node *)n;
				}
 ...
 *****************************************************************************/
 ...
 CreateModelStmt:
 				CREATE MODEL ColId FOR FORECAST OF columnref ON columnref AlgorithmClause opt_storage_clause opt_maintenance_clause opt_algorithm_parameter_list
 					{
						...
						n1->storeModel = $11;
						n1->maintenancetype = $12;
						n1->maintenanceParameters=$13;
...
forecast_clause:
	...
	|
	opt_forecast_clause opt_on_clause NUMBER Iconst opt_algorithm_clause opt_confidence_clause opt_storage_clause opt_mergeclause opt_maintenance_clause opt_algorithm_parameter_list
		{
			...
			n->confidenceIntervalPercentage = $6;
			n->storeModel = $7;
			n->maintenancetype = $9;
			n->maintenanceParameters = $10;
			$$ = (Node *) n;
		}
	|
	opt_forecast_clause opt_on_clause ASOF Sconst opt_algorithm_clause opt_confidence_clause opt_storage_clause opt_mergeclause opt_maintenance_clause opt_algorithm_parameter_list
		{
			ForecastExpr *n = makeNode(ForecastExpr);
			n->measure = $1;
			n->choose= $8;
	...
	|
	opt_forecast_clause opt_on_clause ASOF CURRENT_DATE '+' INTERVAL Iconst granularity_clause opt_algorithm_clause opt_confidence_clause opt_storage_clause opt_mergeclause opt_maintenance_clause opt_algorithm_parameter_list
		{
			ForecastExpr *n = makeNode(ForecastExpr);
			n->measure = $1;
			n->choose= $12;
			...
			n->confidenceIntervalPercentage = $10;
			n->storeModel = $11;
			n->maintenancetype = $13;
			n->maintenanceParameters = $14;
			$$ = (Node *) n;
		}
	;
	
opt_confidence_clause:
	CONFIDENCE
		{
			$$ = makeFloat("0.95");
		}
...
opt_maintenance_clause:
	MAINTENANCE SIMPLEREESTIMATE 
		{
			$$=1;
		}
	| MAINTENANCE OFF
 ...
 *****************************************************************************/
 ...
 FillModelGraphStmt:
 	FILL MODELGRAPH FOR FORECAST OF columnref ON columnref AlgorithmClause fill_method_clause opt_maintenance_clause opt_algorithm_parameter_list
 	{
 		...
 		n->algorithm = (AlgorithmClause *)$9;
 		n->fillMethode = $10;
 		n->maintenanceMethod =$11;
		n->maintenanceParameters=$12;
 		$$ = (Node *)n;
 	};
